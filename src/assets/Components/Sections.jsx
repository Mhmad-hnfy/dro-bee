...
export default function Sections() {
  ...
  return (
    <>
      <div id="categories" data-aos="fade-up">
        <style>{`
            ...
            `}</style>
        <h1 className="text-4xl font-bold text-center mx-auto pt-12 pb-4 text-gray-900 italic uppercase">
          Dro Bee <span className="text-yellow-500">Collections</span>
        </h1>
        ...
        {/* <div className="flex items-center justify-center gap-8 pt-12">
          <div className="max-w-72 w-full hover:-translate-y-0.5 transition duration-300">
            ...
            <p className="text-xs text-yellow-600 font-bold mt-1 uppercase tracking-wider">
              UI/UX design
            </p>
          </div>
          <div className="max-w-72 w-full hover:-translate-y-0.5 transition duration-300">
