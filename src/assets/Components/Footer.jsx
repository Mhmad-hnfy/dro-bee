...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="flex flex-col items-center justify-center w-full py-3 text-black text-center bg-yellow-400">
        <div className="flex flex-wrap justify-center gap-8 mb-8 font-bold uppercase tracking-widest text-xs">
          ...
          <a href="/products" className="hover:opacity-60 transition-opacity">
            {t("nav.products")}
          </a>
          <a href="/cart" className="hover:opacity-60 transition-opacity">
            {t("nav.cart")}
          </a>
        </div>
        ...
        <p className="mt-8 text-center text-sm font-medium text-black/70">
          {t("footer.copyright")} 2026{" "}
          <a
            href="#"
            className="font-bold border-b border-black/20 hover:border-black transition-colors"
          >
            Dro Bee
          </a>
          . {t("footer.rights")}
        ...
        <div className="flex items-center gap-4 mt-5">
          ...
          <a
            href="https://github.com/Mhmad-hnfy "
            className="hover:-translate-y-0.5 transition-all duration-300"
            target="_blank"
          >
            <svg
